...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("vertexShader.vert", "fragmentShader.frag"); // you can name your shader files however you like
    Shader lightCubeShader("cubeVertexShader.txt","cubeFragmentShader.txt");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("spotLight.innerCutOff", glm::cos(glm::radians(12.0f)));
